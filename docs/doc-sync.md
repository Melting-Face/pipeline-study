...
| Claude Code 스킬 | `docs/skills.md` | `skills-lock.json`(등재·`computedHash`) · `.claude/agents/*.md` 프론트매터 `skills:`(프리로드는 **lock 등재분만**) · `.claude/agents/skill-matcher.md`(채점 루브릭) · `CLAUDE.md` 운영 섹션 · `docs/conventions/agents.md` §프론트매터(**주입 단위**) · `docs/README.md` §목차 |
